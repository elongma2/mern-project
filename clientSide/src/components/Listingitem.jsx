...
export default function Listingitem({listing}) {
  ...
  return (
    <div className='bg-white shaow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden 
    rounded-lg w-full sm:w-[330px]'>
        <Link to={`/listing/${listing._id}`}>
            <img className='h-[320px] sm:h-[150px] w-full object-cover hover:scale-105 transition
            -scale duration-300' src={listing.imageUrls[0]} alt='listing cover'/>
