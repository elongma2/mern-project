        ...
        <div>
          ...
          <div className='fixed top-[13%] right-[3%] z-10 border rounded-full w-12 h-12 flex justify-center items-center bg-slate-100 cursor-pointer'>
            <FaShare
              ...
              onClick={() => {
                navigator.clipboard.writeText(window.location.href);//help to copy the text targeting in the url
                setCopied(true);
                setTimeout(() => {
                  setCopied(false);
                }, 2000);
          ...
          <div className='flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4'>
            <p className='text-2xl font-semibold'>
              {listing.name} - ${' '}
              {listing.offer
                ? listing.discountPrice.toLocaleString('en-US')//output based on usd using toLocaleString
            ...
            <p className='text-slate-800 text-left text-balance'> <span className='font-semibold text-black'>Description</span> - {' '}
            {listing.description}
          </p>
